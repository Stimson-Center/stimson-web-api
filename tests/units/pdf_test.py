...
def test_pdf(fixture_directory, client):
    test_driver_file = os.path.join(fixture_directory, "json",
    ...
    test_output_file = os.path.join(fixture_directory, "pdf",
                                    "2015-09-29 Myawaddy industrial zone set for 2017 opening.en.pdf")
